...
set (TPL_Netcdf_LIBRARIES "-L${Netcdf_LIBRARY_DIRS}/lib;${Netcdf_LIBRARY_DIRS}/libnetcdf.so;$ENV{PARALLEL_NETCDF_LIB}/libpnetcdf.a" CACHE STRING "Set by default for CUDA PR testing")
set (Trilinos_ENABLE_ShyLU_DD OFF CACHE BOOL "Disable due to build failure")
set (ML_ENABLE_SuperLU OFF CACHE BOOL "Disabled because we do not have SuperLU<5.0 for intel 2021.3")
